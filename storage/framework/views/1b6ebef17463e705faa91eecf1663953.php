						...
						<div class="card card-flush h-xl-100">
							...
							<div class="card-header pt-7">
								...
								<h3 class="card-title align-items-start flex-column">
									<span class="card-label fw-bold text-gray-900">Persentasi Kehadiran</span>
									<span class="text-gray-500 mt-1 fw-semibold fs-6">Persentasi ini dihitung per bulan</span>
								</h3>
								<!--end::Title-->
							</div>
							<!--end::Header-->
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sever/ols-docker-env/sites/sippus.lib.ibrahimy.ac.id/html/resources/views/admin/home.blade.php ENDPATH**/ ?>