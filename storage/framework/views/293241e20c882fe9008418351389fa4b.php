                    ...
                    <div class="col-xl-4">
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7 bg-success" style="background-image:url('admin/assets//media/pattern.png'); background-size: 300px; background-position: right; background-repeat: no-repeat;">
                                ...
                                <!--end::Title-->
                                <!--begin::Actions-->
                                <?php if(auth()->user()->hasPermissionTo('master pustakawan-edit')): ?>
                            ...
                            <div class="card-body">
                                <div class="pb-5 fs-6">
									...
									<div class="row mb-7 mt-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8">
											<span class="text-gray-800 fw-bold fs-6"><?php echo e($pustakawan->tmt ? Carbon\Carbon::parse($pustakawan->tmt)->isoFormat('dddd, D MMMM Y') : '-'); ?> </span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Row-->
									...
									<div class="row mb-7 mt-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8">
											<span class="text-gray-800 fw-bold fs-6"><?php echo e($pustakawan->tmt_mengajar ? Carbon\Carbon::parse($pustakawan->tmt_mengajar)->isoFormat('dddd, D MMMM Y') : '-'); ?></span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Row-->
									...
									<div class="row mb-7 mt-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8">
											<span class="text-gray-800 fw-bold fs-6">+62 <?php echo e($formatted); ?> </span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Row-->
									...
									<div class="row mb-7 mt-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8">
											<span class="text-gray-800 fw-bold fs-6"><?php echo e($pustakawan->asrama ?? '-'); ?> </span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Row-->
									...
									<div class="row mb-7 mt-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8">
											<span class="text-gray-800 fw-bold fs-6"><?php echo e($pustakawan->sekolah_pagi ?? '-'); ?> </span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Row-->
									...
									<div class="row mb-7 mt-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8">
											<span class="text-gray-800 fw-bold fs-6"><?php echo e($pustakawan->sekolah_sore ?? '-'); ?> </span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Row-->
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sever/ols-docker-env/sites/sippus.lib.ibrahimy.ac.id/html/resources/views/admin/Master/pustakawan/detail_pustakawan.blade.php ENDPATH**/ ?>