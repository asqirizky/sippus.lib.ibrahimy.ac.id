    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 py-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-2xl shadow-2xl h-fit animate-card"
                ...
                <form action="<?php echo e(route('geofencing.store')); ?>" method="POST" class="space-y-5">
                    <?php echo csrf_field(); ?>
                    <div>
                        <label class="block text-xs font-semibold uppercase tracking-wider text-white/80 mb-2">Lokasi
                            Lokasi</label>
                        <input type="text" id="lokasi" name="lokasi" value="<?php echo e($lokasi); ?>"
                    ...
                    <div>
                        <label class="block text-xs font-semibold uppercase tracking-wider text-white/80 mb-2">Latitude
                            Pusat</label>
                        <input type="text" id="latitude" name="latitude" value="<?php echo e($lat); ?>"
                            class="w-full px-4 py-3 rounded-lg bg-white/90 text-slate-800 font-medium focus:outline-none focus:ring-2 focus:ring-blue-400 focus:animate-[pulseGlow_0.6s_ease] transition-all">
                    </div>
                    ...
                    <div>
                        <label class="block text-xs font-semibold uppercase tracking-wider text-white/80 mb-2">Longitude
                            Pusat</label>
                        <input type="text" id="longitude" name="longtitude" value="<?php echo e($lng); ?>"
                            class="w-full px-4 py-3 rounded-lg bg-white/90 text-slate-800 font-medium focus:outline-none focus:ring-2 focus:ring-blue-400 focus:animate-[pulseGlow_0.6s_ease] transition-all">
                    </div>
                    ...
                    <div>
                        <label class="block text-xs font-semibold uppercase tracking-wider text-white/80 mb-2">Radius
                            (Meter)</label>
                        <input type="number" id="radius" name="radius" value="<?php echo e($radius); ?>"
                            class="w-full px-4 py-3 rounded-lg bg-white/90 text-slate-800 font-medium focus:outline-none focus:ring-2 focus:ring-blue-400 focus:animate-[pulseGlow_0.6s_ease] transition-all">
                    </div>
            ...
            <div class="overflow-x-auto rounded-lg">
                <table class="w-full text-left text-sm text-white/90 whitespace-nowrap">
                    ...
                    <tbody class="divide-y divide-white/10">
                        <?php $__empty_1 = true; $__currentLoopData = $riwayatPresensi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-white/10 transition duration-200">
                                <td class="px-6 py-4 font-semibold"><?php echo e($row->nomor_wa); ?></td>
                                <td class="px-6 py-4 font-mono text-xs opacity-80"><?php echo e($row->koordinat); ?></td>
                                <td class="px-6 py-4 opacity-90"><?php echo e($row->created_at->format('d M Y, H:i')); ?> WIB</td>
                            </tr>
...
<?php /**PATH /home/sever/ols-docker-env/sites/sippus.lib.ibrahimy.ac.id/html/resources/views/admin/Absen/geofancing.blade.php ENDPATH**/ ?>