            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <div class="pt-6 border-0 card-header bg-success" style="background-image:url('admin/assets//media/pattern.png'); background-size: 300px; background-position: right; background-repeat: no-repeat;">
                        ...
                        <!--begin::Card title-->
                        <!--begin::Card toolbar-->
                        <?php if(auth()->user()->hasPermissionTo('struktural geofencing-tambah') ): ?>
                    ...
                    <div class="py-4 card-body">
                        ...
                        <table class="table align-middle table-striped fs-6 gy-5" id="kt_ecommerce_products_table">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                <?php $__currentLoopData = $koordinat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td></td>
                                    <td class="text-center">
                                        <div class="px-4 py-3 badge fs-7 badge-light-success"><?php echo e($item->ruang->ruang_pustakawans ?? '-'); ?></div>
                                    </td>
                                    <td class="text-center"></td>
                                    <td class="text-center"><?php echo e($item->latitude); ?></td>
                                    <td class="text-center"><?php echo e($item->longitude); ?></td>
                                    <td class="text-center"><?php echo e($item->radius); ?>m</td>
                                    <td></td>
                                    ...
                                    <a href="#" class="btn btn-sm btn-light-primary btn-active-primary btn-flex btn-center" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Opsi
                                        ...
                                        <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                            <!--begin::Menu item-->
                                            <?php if(auth()->user()->hasPermissionTo('struktural geofencing-edit')): ?>
                                            <div class="px-3 menu-item">
                                                <a href="<?php echo e(route('update-geofencing.lihat', $item->id)); ?>" class="px-3 menu-link">Edit</a>
                                            </div>
                                            <?php endif; ?>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <?php if(auth()->user()->hasPermissionTo('struktural geofencing-hapus')): ?>
                                            <div class="px-3 menu-item">
                                                <a href="<?php echo e(route('geofencing.hapus', $item->id)); ?>" class="px-3 menu-link delete-button">Hapus</a>
                                            </div>
                                            <?php endif; ?>
                                            <!--end::Menu item-->
                                        </div>
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sever/ols-docker-env/sites/sippus.lib.ibrahimy.ac.id/html/resources/views/admin/Struktural/Geofencing/geofencing.blade.php ENDPATH**/ ?>