    ...
    <div class="modal-dialog modal-dialog-centered mw-600px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form class="form" method="POST" action="<?php echo e(route('khidmah.barokah.update', $item->id)); ?>">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>

                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <h1 class="mb-3">Edit Barokah Khidmah</h1>
                    ...
                    <div class="fv-row mb-6 text-start">
                        ...
                        <select name="jenis" class="form-select" data-control="select2" data-hide-search="true" data-placeholder="Pilih Kategori" required>
                            ...
                            <option value="khidmah" <?php echo e($item->jenis == 'khidmah' ? 'selected' : ''); ?>>Tenaga Khidmah</option>
                        </select>
                    </div>
                    <!--end::Input group-->
...
<?php /**PATH /home/sever/ols-docker-env/sites/sippus.lib.ibrahimy.ac.id/html/resources/views/admin/TenagaKhidmah/BarokahKhidmah/barokah_khidmah_update.blade.php ENDPATH**/ ?>