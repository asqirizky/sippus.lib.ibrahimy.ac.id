    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        ...
        <div class="modal-content">
            ...
            <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
                <!--begin:Form-->
                <form id="form_tambah_izin" class="form" method="POST" enctype="multipart/form-data" action="<?php echo e(route('viar.izin.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <!--begin::Heading-->
...
<?php /**PATH /home/sever/ols-docker-env/sites/sippus.lib.ibrahimy.ac.id/html/resources/views/admin/Viar/IzinViar/izin_tambah_viar.blade.php ENDPATH**/ ?>