            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card card-flush">
                    <div class="gap-2 py-5 card-header align-items-center gap-md-5 " style="background-image: url('/admin/assets/media/pattern.png'); background-size: 350px; background-position: right; background-repeat: no-repeat; background-color: #F1416C;">
                        ...
                        <?php echo $__env->make('admin.TenagaKhidmah.RekapKhidmah.proses_tenaga_khidmah', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    ...
                                    <td class="text-center pe-4">
                                        ...
                                        <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                            <div class="px-3 menu-item">
                                                ...
                                                <a href="<?php echo e(route('khidmah.absen.hapus', $item->id)); ?>" class="px-3 menu-link delete-button">Hapus</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sever/ols-docker-env/sites/sippus.lib.ibrahimy.ac.id/html/resources/views/admin/TenagaKhidmah/RekapKhidmah/absen_mandiri_tenaga_khidmah.blade.php ENDPATH**/ ?>