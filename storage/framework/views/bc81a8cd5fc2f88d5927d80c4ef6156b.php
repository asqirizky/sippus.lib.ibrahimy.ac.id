    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        <div class="modal-content">
            ...
            <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
                ...
                <form method="POST" action="<?php echo e(route('viar-mandiri.store')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-6">
                    ...
                    <select id="selectPustakawan" class="form-select" name="nik" data-control="select2" data-hide-search="true" data-placeholder="Pilih Kru Viar" required>
                        ...
                        <?php $__currentLoopData = $kruViar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
const JADWAL_PEGAWAI = <?php echo json_encode($viar_jadwal ?? [], 15, 512) ?>;
...
<?php /**PATH /home/sever/ols-docker-env/sites/sippus.lib.ibrahimy.ac.id/html/resources/views/admin/Viar/RekapViar/proses_viar.blade.php ENDPATH**/ ?>