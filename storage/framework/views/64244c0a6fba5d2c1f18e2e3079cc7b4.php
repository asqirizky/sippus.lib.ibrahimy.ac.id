            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="py-10 card-body">
                        <div class="mb-4 d-flex justify-content-between align-items-center">
                            ...
                            <div class="gap-2 mb-6">
                                <form method="GET" action="<?php echo e(route('tenaga-khidmah.cetak')); ?>" target="_blank" class="mb-4 d-flex align-items-center">
                ...
                <div class="card card-flush">
                    <div class="gap-2 py-5 card-header align-items-center gap-md-5 bg-success" style="background-image: url('/admin/assets/media/pattern.png'); background-size: 350px; background-position: right; background-repeat: no-repeat;">
                        <?php if(auth()->user()->hasPermissionTo('khidmah rekap-mandiri')): ?>
                        <div class="card-title">
                            <a href="<?php echo e(route('khidmah-mandiri')); ?>" class="btn btn-warning me-4">Mandiri</a>
                        </div>
                        <?php endif; ?>
                    ...
                    <div class="py-4 card-body">
                        <table class="table align-middle table-striped table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <?php $__currentLoopData = $absenKhidmah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="ps-4">
                                        <div class="px-4 py-3 badge fs-7 badge-light-success">
                                            
                                            <?php echo e($item->pustakawan->nik ?? '-'); ?> - <?php echo e($item->pustakawan->nama_pustakawan ?? 'Tidak Diketahui'); ?>
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sever/ols-docker-env/sites/sippus.lib.ibrahimy.ac.id/html/resources/views/admin/TenagaKhidmah/RekapKhidmah/rekap_tenaga_khidmah.blade.php ENDPATH**/ ?>