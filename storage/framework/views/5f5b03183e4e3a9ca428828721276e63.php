...
<body class="relative flex items-center justify-center min-h-screen">
  ...
  <div class="relative z-10 w-full max-w-md p-10 text-center shadow-2xl bg-white/10 backdrop-blur-md rounded-2xl animate-card">
    ...
    <!-- Form -->
    <form class="form" method="POST" action="<?php echo e(route('absen-viar-proses')); ?>">
      <?php echo csrf_field(); ?>
      <!-- Input NIK -->
      <div>
...
<?php /**PATH /home/sever/ols-docker-env/sites/sippus.lib.ibrahimy.ac.id/html/resources/views/admin/Absen/absen_viar.blade.php ENDPATH**/ ?>