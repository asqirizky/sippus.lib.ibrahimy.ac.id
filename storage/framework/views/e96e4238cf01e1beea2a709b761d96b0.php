            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
                    ...
                    <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                        ...
                        <!--end::Item-->
                        <li class="breadcrumb-item text-muted">Master Konfigurasi</li>
                        <li class="breadcrumb-item">
                            <span class="bg-gray-500 bullet w-5px h-2px"></span>
                        </li>
                        <!--begin::Item-->
                        ...
                        <table class="table align-middle table-striped table-row-dashed fs-6 gy-5" >
                            <thead class="fw-bold fs-5 " style="background-color: #7239EA;">
                                <tr class="text-white text-start fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-start min-w-150px">Kategori / Peruntukan</th>
                                    <th class="text-center min-w-150px">Nominal Barokah</th>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $barokah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td class="text-start text-gray-800 fw-bold">
                                        <!-- Menampilkan label yang rapi berdasarkan string ENUM -->
                                        <?php if($item->tipe_barokah === 'viar'): ?>
                                            <span class="badge badge-light-success fs-7 fw-bold">Tenaga Viar (Perpustakaan)</span>
                                        <?php else: ?>
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sever/ols-docker-env/sites/sippus.lib.ibrahimy.ac.id/html/resources/views/admin/Viar/BarokahViar/barokah_viar.blade.php ENDPATH**/ ?>