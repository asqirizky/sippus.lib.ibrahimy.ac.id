                ...
                <div class="card">
                    ...
                    <div class="pt-6 border-0 card-header align-items-center gap-md-5 bg-success" style="background-image: url('/admin/assets/media/pattern.png'); background-size: 350px; background-position: right; background-repeat: no-repeat;">
                        ...
                        <div class="gap-2 card-toolbar d-flex justify-content-end align-items-center">
                            <!--begin::Card toolbar-->
                            <?php if(auth()->user()->hasPermissionTo('khidmah barokah-tambah')): ?>
                            <div class="card-title">
                                ...
                                <!--end::Select-->
                                <?php echo $__env->make('admin.TenagaKhidmah.BarokahKhidmah.TambahBarokahKhidmah', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <?php endif; ?>
                            <!--end::Card toolbar-->
                        </div>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $barokah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td class=" text-gray-800 fw-bold">
                                        ...
                                        <?php if($item->tipe_barokah === 'tenaga_khidmah'): ?>
                                            <span class="badge badge-light-success fs-7 fw-bold">Tenaga Khidmah (Perpustakaan)</span>
                                        <?php else: ?>
                                            <span class="badge badge-light-primary fs-7 fw-bold"><?php echo e(ucfirst($item->tipe_barokah)); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="text-center fw-bold text-gray-900">
                                        Rp <?php echo e(number_format($item->barokah, 0, ',', '.')); ?>
                                    ...
                                    <a href="#" class="btn btn-sm btn-light-primary btn-active-primary btn-flex btn-center" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Opsi
                                        ...
                                        <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                            <!--begin::Menu item-->
                                            <?php if(auth()->user()->hasPermissionTo('khidmah barokah-edit')): ?>
                                            ...
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <?php if(auth()->user()->hasPermissionTo('khidmah barokah-hapus')): ?>
                                            <div class="px-3 menu-item">
                                                <a href="<?php echo e(route('khidmah.barokah.destroy', $item->id)); ?>" class="px-3 menu-link delete-button" data-kt-users-table-filter="delete_row" data-confirm-delete="true">Hapus</a>
                                            </div>
                                            <?php endif; ?>
                                            <!--end::Menu item-->
                                        </div>
                                        <!--end::Menu-->
                                        <?php echo $__env->make('admin.TenagaKhidmah.BarokahKhidmah.barokah_khidmah_update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sever/ols-docker-env/sites/sippus.lib.ibrahimy.ac.id/html/resources/views/admin/TenagaKhidmah/BarokahKhidmah/BarokahTenagaKhidmah.blade.php ENDPATH**/ ?>