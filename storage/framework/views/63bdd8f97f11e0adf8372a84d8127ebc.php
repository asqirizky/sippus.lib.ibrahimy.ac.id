                    ...
                    <div class="pt-6 border-0 card-header bg-success" style="background-image:url('admin/assets//media/pattern.png'); background-size: 300px; background-position: right; background-repeat: no-repeat;">
                        ...
                        <!--begin::Card toolbar-->
                            <div class="card-toolbar">
                                <?php if(auth()->user()->hasPermissionTo('tunjangan kehadiran-tambah')): ?>
                                    ...
                                    <td class="text-center pe-4">
                                        <a href="#" class="btn btn-sm btn-light-primary btn-active-primary btn-flex btn-center" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Opsi
                                            ...
                                            <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                                <!--begin::Menu item-->
                                                <?php if(auth()->user()->hasPermissionTo('tunjangan kehadiran-edit')): ?>
                                                ...
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <?php if(auth()->user()->hasPermissionTo('tunjangan kehadiran-hapus')): ?>
                                                <div class="px-3 menu-item">
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sever/ols-docker-env/sites/sippus.lib.ibrahimy.ac.id/html/resources/views/admin/Payroll/kehadiran/kehadiran.blade.php ENDPATH**/ ?>