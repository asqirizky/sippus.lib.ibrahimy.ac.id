			...
			<div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card card-flush">
                    ...
                    <div class="gap-2 py-5 card-header align-items-center gap-md-5 bg-success">
                        ...
                        <!--end::Card title-->
                        <?php echo $__env->make('admin.Struktural.RekapStruktural.proses', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <!--begin::Card title-->
                                    ...
                                    <td class="text-center pe-4">
                                        ...
                                        <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                            ...
                                            <div class="px-3 menu-item">
                                                <a href="<?php echo e(route('struktural-absen.hapus', $item->id)); ?>" class="px-3 menu-link delete-button">Hapus</a>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                        <!--end::Menu-->
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sever/ols-docker-env/sites/sippus.lib.ibrahimy.ac.id/html/resources/views/admin/Struktural/RekapStruktural/absen_mandiri.blade.php ENDPATH**/ ?>