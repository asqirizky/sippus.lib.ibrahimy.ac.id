        ...
        <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
            ...
            <form class="form" method="POST" enctype="multipart/form-data" action="<?php echo e(route('struktural-izin.store')); ?>">
                ...
                <div class="text-center mb-13">
                    <!--begin::Title-->
                    <h1 class="mb-3">Update Izin Struktural</h1>
                ...
                <div class="mb-6">
                    ...
                    <select class="form-select" name="pustakawan_id" data-control="select2" data-hide-search="true" data-placeholder="Pilih Pustakawan" required>
                        <option value="" disabled selected>Pilih Pustakawan</option>
                         <?php $__currentLoopData = $izinPustakawan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($item->id); ?>"><?php echo e($item->pustakawan->nama_pustakawan); ?></option>
...
<?php /**PATH /home/sever/ols-docker-env/sites/sippus.lib.ibrahimy.ac.id/html/resources/views/admin/Struktural/IzinStruktural/izin_update.blade.php ENDPATH**/ ?>