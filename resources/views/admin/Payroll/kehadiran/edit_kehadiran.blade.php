...
<div class="modal fade" id="kt_modal_new_target{{ $item->id }}" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        ...
        <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
            <!--begin:Form-->
            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('payroll-kehadiran.update', $item->id) }}">
                @csrf
                @method('PUT')
                <!--begin::Heading-->
                ...
                <div class="mb-8 fv-row text-start">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="text" name="tunjangan" class="form-control form-control-lg" value="{{ number_format($item->tunjangan ?? 0, 0, ',', '.') }}" placeholder="Tunjangan Kehadiran">
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
