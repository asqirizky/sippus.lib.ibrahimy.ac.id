        ...
        <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
            ...
            <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="{{ route('pengguna.update', $item->id) }}">
                ...
                <div class="mb-13 text-center">
                    ...
                    <div class="text-muted fw-semibold fs-5">Edit data {{ $item->pustakawan->nama_pustakawan }} </div>
                    <!--end::Title-->
                </div>
                <!--end::Heading-->
                <!--begin::Input group-->
                ...
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" class="form-control mb-3 mb-lg-0" value="{{ $item->pustakawan->nama_pustakawan }}" readonly/>
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
