                                ...
                                <tr>
                                    ...
                                    <td class="text-start">
                                        <div class="px-4 py-3 badge fs-7 badge-light-success">
                                            {{ $item->pustakawan->nama_pustakawan ?? '-' }}
                                        </div>
                                    </td>
                                    <td class="text-center">{{ $item->t_jabatan ? number_format($item->t_jabatan->tunjangan_jabatan, 0, ',', '.') : '-' }}</td>
                                    <td class="text-center">{{ $item->t_pengabdian ? number_format($item->t_pengabdian->tunjangan_pengabdian, 0, ',', ',') : '-' }}</td>
                                    <td class="text-center">{{ $item->t_kehadiran ? number_format($item->t_kehadiran->tunjangan, 0, ',', ',') : '-' }}</td>
                                    <td class="text-center">{{ $item->t_tunkel ? number_format($item->t_tunkel->tunkel, 0, ',', ',') : '-' }}</td>
                                    <td class="text-center">{{ $item->t_anak ? number_format($item->t_anak->tunjangan_anak, 0, ',', ',') : '-' }}</td>
                                    <td class="text-center">{{ $item->t_kehormatan ? number_format($item->t_kehormatan->tunjangan_kehormatan, 0, ',', ',') : '-' }}</td>
                                    <td class="text-center">{{ $item->t_dosen ? number_format($item->t_dosen->t_rank_dosen, 0, ',', ',') : '-' }}</td>
