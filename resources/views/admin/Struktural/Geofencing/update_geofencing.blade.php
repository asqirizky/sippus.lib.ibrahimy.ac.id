    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('koordinat-lokasi.update', $koordinat->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="row g-5">
                        <div class="col-lg-4">
                            <div class="card card-flush shadow-sm">
                                ...
                                <div class="card-body">
                                        ...
                                        <select name="ruang_id" class="form-select" data-control="select2" data-hide-search="true">
                                            ...
                                            @foreach ($ruang as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ old('ruang_id', $koordinat->ruang_id) == $item->id ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="text" id="latitude" class="form-control" name="latitude" placeholder="Latitude" value="{{ old('latitude', $koordinat->latitude) }}">
                                    </div>
                                    <div class="mb-5">
                                        <label class="required form-label">Longitude</label>
                                        <input type="text" id="longitude" class="form-control" name="longitude" placeholder="Longitude" value="{{ old('longitude', $koordinat->longitude) }}">
                                    </div>
                                    <div class="mb-5">
                                        <label class="required form-label">Radius (Meter)</label>
                                        <input type="number" id="radius" class="form-control" name="radius" placeholder="Radius" value="{{ old('radius', $koordinat->radius) }}">
                                    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        let initialLat = {{ $koordinat->latitude }};
        let initialLng = {{ $koordinat->longitude }};
        let initialRadius = {{ $koordinat->radius }};
