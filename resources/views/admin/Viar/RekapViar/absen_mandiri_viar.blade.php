        ...
        <div id="kt_app_toolbar" class="py-3 app-toolbar py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
                    {{-- PERBAIKAN: Judul Halaman disesuaikan menjadi Kru Viar --}}
                    ...
                    <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                        ...
                        {{-- PERBAIKAN: Teks Breadcrumb disesuaikan --}}
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="mb-5 card mb-xl-10">
                    <div class="py-10 card-body">
                        <div class="mb-4 d-flex justify-content-between align-items-center">
                            {{-- PERBAIKAN: Judul Banner disesuaikan --}}
                ...
                <div class="card card-flush">
                    <div class="gap-2 py-5 card-header align-items-center gap-md-5 " style="background-image:url('admin/assets//media/pattern.png'); background-size: 300px; background-position: right; background-repeat: no-repeat; background-color: #7239EA;">
                        ...
                        {{-- PERBAIKAN: Include modal diarahkan ke file proses modal Kru Viar yang baru --}}
                        @include('admin.Viar.RekapViar.proses_viar')
                    ...
                    <div class="py-4 card-body">
                        <table class="table align-middle table-striped table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            </thead> {{-- PERBAIKAN: Di sini kemarin tertulis </table> --}}

                            <tbody class="text-gray-600 fw-semibold">
                            {{-- PERBAIKAN: Berpindah menggunakan variabel $absenViar dari controller baru --}}
                            @foreach ($absenViar as $item)
                                <tr>
                                    <td class="ps-4">
                                        <div class="px-4 py-3 badge fs-7 badge-light-success">
                                            {{-- PERBAIKAN: Memanggil properti langsung dari hasil flat join Query Builder --}}
                                    ...
                                    {{-- PERBAIKAN: Mengambil nama shift langsung via properti kolom hasil join ($item->jadwal) --}}
                                    ...
                                    <td class="text-center pe-4">
                                        ...
                                        <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                            <div class="px-3 menu-item">
                                                ...
                                                <a href="{{ route('viar.absen.hapus', $item->id) }}" class="px-3 menu-link delete-button">Hapus</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
