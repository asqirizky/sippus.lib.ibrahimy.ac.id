                    ...
                    <div class="py-10 card-body">
                        <div class="mb-4 d-flex justify-content-between align-items-center">
                            ...
                            <div class="gap-2 mb-6">
                                {{-- KUNCI: Rute cetak disesuaikan ke rute cetak laporan viar Anda nantinya --}}
                                <form method="GET" action="{{ route('viar.cetak') }}" target="_blank" class="mb-4 d-flex align-items-center">
