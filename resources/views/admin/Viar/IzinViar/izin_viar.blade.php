                    ...
                    <div class="pt-6 border-0 card-header" style="background-image:url('admin/assets//media/pattern.png'); background-size: 300px; background-position: right; background-repeat: no-repeat; background-color: #7239EA;">
                        ...
                        <div class="card-toolbar">
                            <form method="GET" class="d-flex align-items-center gap-3">
                                ...
                                @if (auth()->user()->hasPermissionTo('viar izin-tambah'))
                            ...
                            @include('admin.Viar.IzinViar.izin_tambah_viar')
                        </div>
                        <!--end::Card toolbar-->
                    </div>
                    <!--end::Card header-->
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr>
                                    ...
                                    <a href="#" class="btn btn-sm btn-light-primary btn-active-primary btn-flex btn-center" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Opsi
                                        ...
                                        @if (auth()->user()->hasPermissionTo('viar izin-hapus'))
                                            <!--begin::Menu item-->
                                            <div class="px-3 menu-item">
                                                <a href="{{ route('viar.izin.destroy', $item->id) }}" class="px-3 menu-link delete-button" data-kt-users-table-filter="delete_row" data-confirm-delete="true">Hapus</a>
                                            </div>
                                            <!--end::Menu item-->
                                        @endif
                                        </div>
