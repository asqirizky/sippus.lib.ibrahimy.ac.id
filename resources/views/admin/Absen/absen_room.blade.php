		...
		<div id="kt_app_content" class="app-content flex-column-fluid">
			...
			<div id="kt_app_content_container" class="app-container container-xxl">
				...
				<div class="row g-5 gx-xl-10 mb-5 mb-xl-10">
					...
					<div class="col-xl-3">
						<a href="{{ url('absen-khidmah-room') }}" class="card-link">
							<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100 card-hover-dark"
								style="background-color:#F1416C; background-image:url('{{ asset('admin/assets/media/pattern.png') }}')">
								<!--begin::Header-->
								<div class="card-header pt-5 mb-3">
									<!--begin::Icon-->
					...
					<!--end::Col-->
                    {{-- Absen khidmah Dummy end --}}
                    {{-- Absen Viar Baru start --}}
                    <!--begin::Col-->
					<div class="col-xl-3">
						<a href="{{ url('absen-viar-room') }}" class="card-link">
							<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100 card-hover-dark"
								style="background-color: #7239EA; background-image:url('{{ asset('admin/assets/media/pattern.png') }}')">
								<!--begin::Header-->
								<div class="card-header pt-5 mb-3">
									<!--begin::Icon-->
