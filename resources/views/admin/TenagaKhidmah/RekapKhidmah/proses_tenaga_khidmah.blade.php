    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        <div class="modal-content">
            ...
            <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
                {{-- DISESUAIKAN: Mengarah ke route store khusus Tenaga Khidmah --}}
                <form method="POST" action="{{ route('khidmah-mandiri.store') }}">
                @csrf
                {{-- PILIH TENAGA KHIDMAH --}}
                <div class="mb-6">
                    ...
                    <select id="selectPustakawan" class="form-select" name="nik" data-control="select2" data-hide-search="true" data-placeholder="Pilih Tenaga Khidmah" required>
                        ...
                        {{-- DISESUAIKAN: Menyesuaikan variabel list personil Tenaga Khidmah --}}
                        @foreach ($tenagaKhidmah ?? $pustakawan as $item)
...
const JADWAL_PEGAWAI = @json($pustakawan_jadwal ?? $khidmah_jadwal ?? []);
