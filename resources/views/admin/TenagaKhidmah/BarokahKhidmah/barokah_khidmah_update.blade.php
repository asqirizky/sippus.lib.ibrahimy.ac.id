    ...
    <div class="modal-dialog modal-dialog-centered mw-600px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form class="form" method="POST" action="{{ route('khidmah.barokah.update', $item->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="fv-row mb-6 text-start">
                        ...
                        <select name="jenis" class="form-select" data-control="select2" data-hide-search="true" data-placeholder="Pilih Kategori" required>
                            ...
                            <option value="khidmah" {{ $item->jenis == 'khidmah' ? 'selected' : '' }}>Tenaga Khidmah</option>
                        </select>
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="fv-row mb-8 text-start">
                        ...
                        <div class="input-group mb-5">
                            ...
                            <input name="barokah" type="text" class="form-control" placeholder="Contoh: 50000" value="{{ $item->barokah }}" oninput="this.value = this.value.replace(/\D/g, '');" required />
                        </div>
                    </div>
                    <!--end::Input group-->
